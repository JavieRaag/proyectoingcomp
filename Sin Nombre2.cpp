        ...
        cout<<"Elegiste -"<<opcionesn<<"- \nBarras disponibles:"<<barras<< endl;
                ...
                cout<<"Elegise -"<<opcionesn<<"- \nBarras disponibles:"<<barras<< endl;
                    ...
                    cout<<"Siguió el  mapa pero a mitad de camino le ofrecieron mucha comida a cambio de el \n Quedó con "<< barras<< " barras \n Elige su proxima acción \n1.Cambiar el mapa e intentar llegar sin el \n2.Rechazar la oferta y seguir el camino \n3.Estafar al que le propuso el cambio \n4.Salir del programa" << std::endl;
                        ...
                        break;
                        case 2:barras-=6;
                        cout<<"Rechazó la oferta y no tuvo suficiente energia para llegar y, ¡No logró llegar a la granja!" << std::endl;
                        break;
                        case 3:barras-=6;
                ...
                cout<<"Elegise -"<<opcionesn<<"- \nBarras disponibles:"<<barras<< endl;
                    ...
                    cout<<"Abrió el mapa y vio que estaba un poco lejos de la granja \n Quedó con "<< barras<< " barras \n Elige su proxima acción \n1.Irse sin comer nadamas \n2.Buscar agua y despues intentar llegar a la granja \n3.Descansar antes de partir a la granja\n4.Salir del programa" << std::endl;
                        ...
                        break;
                        case 3:barras-=0;
                        cout<<"Se quedó dormido y le robaron el mapa, ¡No logró llegar a la granja!\n ¡Ni modo!\n Quedó con "<<barras<< " barras" << std::endl;
                        break;
                        default:
                        cout<<"Elige una opcion correcta"<<endl;
                        }
            ...
            cout<<"Elegiste -"<<opcionesn<<"- \nBarras disponibles:"<<barras<< endl;
                    ...
                    cin>>opcionesn;
                        ...
                        cout<<"Intentó hacer nuevos amigos y lo consiguió aunque le adivirtieron que no era tan buen lugar \n Quedó con "<< barras<< " barras \n Elige su proxima acción \n1.Quedarse en la granja \n2.Intentar irse \n3.Preguntarles porqué\n4.Salir del programa" << std::endl;
	                               ...
	                               break;
	                               case 3:barras-=0;
	                               cout<<"Les preguntó porqué y ellos le dijeron que pronto lo averiguaria \n ¡Quedó atrapado!\n ¡Que mala suerte!\n Quedó con "<<barras<< " barras" << std::endl;
	                               break;
	                               case 4:
	                               return 0;
	                               default:
                    ...
                    cin>>opcionesn;
                		...
                		cin>>opcionesn;
                            ...
                            break;
                            case 3:barras-=1;
                            cout<<"Intentó salir de la granja pero se dió cuenta que es casi imposible, ya que las entradas estan revisadas siempre \n ¡No logró llegar!\n ¡Quedó atrapado!\n Quedó con "<<barras<< " barras" << std::endl;
                            break;
                            case 4:
                            return 0;
                            default:
                    ...
                    cin>>opcionesn;
                		...
                		cin>>opcionesn;
                            ...
                            {  
                            case 1:barras-=1;
                            cout<<"Habló con el gallo, quien le contó que ahora no iba a poder salir de la granja y es por eso que los otros animales no querian decirselo, ¡No lo logró!\n ¡Resultó ser una estafa!\n Quedó con "<<barras<< " barras" << std::endl;
                            break;
                            case 2:
            ...
            cout<<"Elegiste -"<<opcionesn<<"- \nBarras disponibles:"<<barras<< endl;
                    ...
                    cout<<"Se metió a la granja de infiltrado y vió muchos cerditos como el \n Quedó con "<<barras<< " barras \n Elige su proxima acción \n1.Hablarle a los demas cerditos \n2.Alejarse de ellos y esconderse \n3.Irse a otra zona de la granja\n4.Salir del programa" << std::endl;
                        ...
                        cout<<"Elegiste -"<<opcionesn<<"- \nBarras disponibles:"<<barras<< endl;
                            ...
                            {
                            case 1:barras-=1;
                            cout<<"Los cerdos le contaron lo que pasa en esa granja, y fue cuando se dió cuenta que habia cometido un error ¡No logró ir con sus amigos!\n ¡Quedó atrapado en esa comoda granja!\n Quedó con "<<barras<< " barras" << std::endl;
                            break;
                            case 2:barras+=5;
            ...
            cout<<"Elegiste -"<<opcionesn<<"- \nBarras disponibles:"<<barras<< endl;
                    ...
                    cout<<"Se relajó y le gustó de mas la nueva granja, es muy comoda y espaciosa \n Quedó con "<< barras<< " barras \n Elige su proxima acción \n1.Espiar al dueño \n2.Salirse e irse \n3.Empezar a conocer animales\n4.Salir del programa" << endl;
                		...
                		cin>>opcionesn;
                            ...
                            {  
                            case 1:barras-=1;
                            cout<<"Se lo conto a los demas animales y estos iniciaron una revolucion, el dueño termino huyendo ¡Lo logró, salvo la nueva granja!\n ¡Hurra!\n Quedó con "<<barras<< " barras" << std::endl;
                            break;
                            case 2:barras-=6;
                            cout<<"Se escapó, pero se quedo sin barras y, ¡No logró llegar a la granja!\n¡Sus amigos se quedaron esperandolo!\n Quedó con "<<barras<< " barras" << std::endl;
                            break;
            ...
            cout<<"Elegiste -"<<opcionesn<<"- \nBarras disponibles:"<<barras<< endl;
                ...
                switch(opcionesn)
                        ...
                        cout<<"La verdura que compró estaba podrida \n Quedó con "<< barras<< " barras \n Elige su proxima acción \n1.Tirarla y emprender el viaje a la granja \n2.Guardarla por si la ocupa durante el camino a la granja \n3.Tomar pura agua durante el camino a la granja\n4.Salir del programa" << std::endl;
                            ...
                            break;
                            case 3:barras+=4;
                            cout<<"El agua fue suficiente para poder encontrar la granja, apenas y llegó \n ¡Logró llegar!\n ¡Lo habian extrañado mucho!\n Quedó con "<<barras<< " barras" << std::endl;
                            break;
                            case 4:
                            return 0;
                            default:
                ...
                switch(opcionesn)
                        ...
                        cout<<"Ahora debe ir a salvar a sus amigos de un incendió \n Quedó con "<< barras<< " barras \n Elige su proxima acción \n1.Buscar un celular \n2.Correr a una ciudad habitada para buscar ayuda \n3.Creer que no es real lo que esta viviendo\n4.Salir del programa" << std::endl;
                            ...
                            break;
                            case 2:barras-=1;
                            cout<<"Intentó llegar a una ciudad habitada pero ya no podia salir del pueblo abandonado ¡Se quedó atrapado en el!\n¡Qué mala suerte!\n Quedó con "<<barras<< " barras" << std::endl;
                            break;
                            case 3:
                ...
                switch(opcionesn)
                        ...
                        cout<<"Las comió y no le paso nada y hasta le dieron mas energia \n Quedó con "<< barras<< " barras \n Elige su proxima acción \n1.Empezar el viaje a la granja \n2.Ir a la tienda de tecnologia \n3.Ir a la avenida y pelearse con un condutor por el carro\n4.Salir del programa" << std::endl;
                            ...
                            break;
                            case 2:barras-=6;
                            cout<<"Fue a la tienda y encontró un patin electrico en el que se fue pero se acabó la bateria y, ¡No logró llegar a la granja!\n¡Qué mala suerte!\n Quedó con "<<barras<< " barras" << std::endl;
                            break;
                            case 3:barras-=6;
            ...
            cout<<"Elegiste -"<<opcionesn<<"- \nBarras disponibles:"<<barras<< endl;
                ...
                switch(opcionesn)
                        ...
                        cout<<"Confió en el adolescente y este le dejó un mapa y la bicicleta arreglada \n Quedó con "<< barras<< " barras \n Elige su proxima acción \n1.Darle las gracias y darle su unica botella de agua \n2.Mientras lo hacia, alejarse de el \n3.Preguntarle porqué le ayudó\n4.Salir del programa" << std::endl;
                            ...
                            break;
                            case 3:barras-=1;
                            cout<<"Le preguntó porque le ayudo y el adolescente solo contesto que hay que ahcer el bien, Pascal llego en la bicicleta a la granja \n ¡Logró llegar!\n ¡Lo habian extrañado mucho!\n Quedó con "<<barras<< " barras" << std::endl;
                            break;
                            case 4:
                            return 0;
                            default:
                ...
                switch(opcionesn)
                        ...
                        cout<<"Apiló las cosas y cuando lo iba alcanzar se derribaron las cosas y Pascal cayó \n Quedó con "<< barras<< " barras \n Elige su proxima acción \n1.Levantarse y actuar como si nada \n2.Reposar y curarse el golpe \n3.Ponerse una crema y seguir poniendo el aceite\n4.Salir del programa" << std::endl;
                            ...
                            break;
                            case 3:barras-=1;
                            cout<<"Le puso el aceite a la bici y alcanzó a llegar con la energia que tenia \n ¡Logró llegar!\n ¡Lo habian extrañado mucho!\n Quedó con "<<barras<< " barras" << std::endl;
                            break;
                            case 4:
                            return 0;
                            default:
                        ...
                        cout<<"Tiró el mueble pero le cayo encima, ahora le duele mucho el cuerpo \n Quedó con "<< barras<< " barras \n Elige su proxima acción \n1.Intentar levantarse \n2.Quedarse tirado hasta que pase el dolor para poder aplicar el aceite e irse \n3.Levantarse e ir por comida para ir a la granja\n4.Salir del programa" << std::endl;
                            ...
                            {   
                            case 1:barras-=6;
                            cout<<"Se levantó pero no tuvo la sigueinte fuerza para seguir adelante, ¡No logró llegar a la granja!\n ¡Que mala suerte!\n Quedó con "<<barras<< " barras" << std::endl;
                            break;
                            case 2:barras-=6;
                        ...
                        cout<<"Buscó comida y encontro solo agua unas cuantas frutas y azucar \n Quedó con "<< barras<< " barras \n Elige su proxima acción \n1.Hacer un jugo que dará mucha energia \n2.Tomarse el agua y guardar las frutas para sus amigos \n3.Guardarlo e iniciar el viaje\n4.Salir del programa" << std::endl;
                            ...
                            break;
                            case 3:barras-=6;
                            cout<<"No repartió bien su comida y se quedo varado en el camino \n ¡No logró llegar a la granja!\n ¡Qué mala suerte!\n Quedó con "<<barras<< " barras" << std::endl;
                            break;
                            case 4:
                            return 0;
                            default:
            ...
            cout<<"Elegiste -"<<opcionesn<<"- \nBarras disponibles:"<<barras<< endl;
                ...
                switch(opcionesn)
                        ...
                        cout<<"Buscó y encontró mucha comida enlatada que metió dentro de una mochila que carga \n Quedó con "<< barras<< " barras \n Elige su proxima acción \n1.Dejar un poco de comida para que no gaste tanta energia \n2.Llevarse toda la comida que pueda\n3.Comer la mitad\n4.Salir del programa" << std::endl;
			 			cin>>opcionesn;
                            ...
                            {  
                            case 1:barras-=6;
                            cout<<"La poquita que dejo fue la que le hizo falta para llegar a la granja ¡No logró llegar a la granja!\n ¡Que mala elección!\n Quedó con "<<barras<< " barras" << std::endl;
                            break;
                            case 2:barras+=6;
                ...
                switch(opcionesn)
                		...
                		cin>>opcionesn;
                            ...
                            {  
                            case 1:barras+=5;
                            cout<<"Con la comida y la brujula, Pascal llego facilmente a la granja, ¡Lo logró!\n ¡Lo habian extrañado mucho!\n Quedó con "<<barras<< " barras" << std::endl;
                            break;
                            case 2:barras-=6;
                		...
                		cin>>opcionesn;
                            ...
                            break;
                            case 2:barras-=1;
                            cout<<"Lo encontró y fue rapido a la granja a ayudar a sus amigos y se fueron a vivir a otra granja¡Sí logró llegar a la granja!\n¡Los salvo del dueño malo!\n Quedó con "<<barras<< " barras" << std::endl;
                            break;
                            case 3:barras-=1;
                ...
                switch(opcionesn)
                		...
                		cin>>opcionesn;
                            ...
                            {  
                            case 1:barras-=1;
                            cout<<"Fue a los helados y al llegar el puesto lo absobió y no se supo nada mas ¡No logró reunirse con sus amigos!\n ¡Qué lastima!\n Quedó con "<<barras<< " barras" << std::endl;
                            break;
                            case 2:
            ...
            cout<<"Elegiste -"<<opcionesn<<"- \nBarras disponibles:"<<barras<< endl;
                ...
                switch(opcionesn)
                        ...
                        cout<<"Aceptó la ayuda del pescador y le dió la comida solo tiene que esperar a que le digan el camino \n Quedó con "<< barras<< " barras \n Elige su proxima acción \n1.No esperar más y preguntarle al pescador \n2.Ser paciente \n3.Pedirle más agua para el camino\n4.Salir del programa" << std::endl;
                            	  ...
                            	  break;
                            	  case 3:barras+=4;
                            	  cout<<"Le dió mas agua el pescador y Pascal llegó bien hidratado a la granja \n ¡Logró llegar!\n ¡Lo habian extrañado mucho!\n Quedó con "<<barras<< " barras" << std::endl;
                            	  break;
                            	  case 4:
                            	  return 0;
                           	   	  default:
                ...
                switch(opcionesn)
                        ...
                        cout<<"Le dice que el esta muy solo y que podrias ser su acompañante \n Quedó con "<< barras << " barras \n Elige su proxima acción \n1.Aceptar ser su acompañante \n2.Decirle que puede visitarlo muy seguido si le ayuda \n3.Rechazarlo\n4.Salir del programa" << std::endl;
                            	  ...
                            	  {
                            	  case 1:
                            	  cout<<"Se quedó con el y ahora hacen un gran equipo ¡Encontró un nuevo hogar!\n ¡Que feliz!\n Quedó con "<<barras<< " barras" << std::endl;
                            	  break;
                            	  case 2:barras-=1;
                            	  cout<<"El pescador acepta y lo ayuda a llegar a la granja, ¡Sí logró llegar a la granja!\n¡Qué buena onda!\n Quedó con "<<barras<< " barras" << std::endl;
                            	  break;
                            	  case 3:barras-=6;
            ...
            cout<<"Elegiste -"<<opcionesn<<"- \nBarras disponibles:"<<barras<< endl;
                ...
                switch(opcionesn)
                        ...
                        cout<<"Elige pagar el taxi pero se da cuenta que se le cayó una parte del dinero \n Quedó con "<< barras<< " barras \n Elige su proxima acción \n1.Seguir aun asi \n2.Buscarlo \n3.Irse caminando\n4.Salir del programa" << std::endl;
                            	  ...
                            	  {
                            	  case 1:barras-=6;
                            	  cout<<"Siguio y si le alcanzo ¡Lo logró!\n ¡Lo habian extrañado mucho!\n Quedó con "<<barras<< " barras" << std::endl;
                            	  break;
                            	  case 2:barras-=6;
                            	  cout<<"Lo buscopero se quedo sin barras y, ¡No logró llegar a la granja!\n¡Qué mala suerte!\n Quedó con "<<barras<< " barras" << std::endl;
                            	  break;
                            	  case 3:barras+=5;
                            	  cout<<"Compro comida en el camino y se fue caminando¡Logró llegar!\n ¡Lo habian extrañado mucho!\n Quedó con "<<barras<< " barras" << std::endl;
                            	  break;
                            	  case 4:
                            	  return 0;
                           	   	  default:
                        ...
                        cout<<"Va caminando pero ve que le hace falta alimento a él \n Quedó con "<< barras<< " barras \n Elige su proxima acción \n1.Comprarse para el\n2.Arriesgar y no comprar \n3.Pagar un taxi" << std::endl;
                            	  ...
                            	  { 
                            	  case 1:barras+=8;
                            	  cout<<"Se compro demasiada comida y tuvo barras de energia de sobra, ¡Lo logró!\n ¡Lo habian extrañado mucho!\n Quedó con "<<barras<< " barras" << std::endl;
                            	  break;
                            	  case 2:barras-=6;
                            	  cout<<"Se arriesgo, pero se quedo sin energia y, ¡No logró llegar a la granja!\n¡Qué mala suerte!\n Quedó con "<<barras<< " barras" << std::endl;
                            	  break;
                            	  case 3:
                            	  cout<<"Pago un taxi que lo llevó a la granja \n ¡Logró llegar!\n ¡Lo habian extrañado mucho!\n Quedó con "<<barras<< " barras" << std::endl;
                            	  break;
                            	  case 4:
                            	  return 0;
                           	   	  default:
                        ...
                        cout<<"Ya le falta poco para lograr juntar para los dos \n Quedó con "<< barras<< " barras \n Elige su proxima acción \n1.Irse ya asi \n2.Dar un ultimo esfuerzo \n3.Invertirlo todo en comida\n4.Salir del programa" << std::endl;
                            	  ...
                            	  {  
                            	  case 1:barras+=6;
                            	  cout<<"Se compro para el taxi y comida, ¡Lo logró!\n ¡Lo habian extrañado mucho!\n Quedó con "<<barras<< " barras" << std::endl;
                            	  break;
                            	  case 2:barras+=4;
                            	  cout<<"Logro juntar para los dos ¡Si logró llegar a la granja!\n¡Qué buena suerte!\n Quedó con "<<barras<< " barras" << std::endl;
                            	  break;
                            	  case 3:barras+=5;
                ...
                switch(opcionesn)
                        ...
                        cout<<"Se hace el muerto y funciona, lo pone sobre su sillón para pensar que hacer con el \n Quedó con "<< barras<< " barras \n Elige su proxima acción \n1.Esperar a que se vaya para tomar todo lo que pueda e irse \n2.Seguir haciendose el muerto \n3.Cuando lo termine de acomodar atacarlo y correr\n4.Salir del programa" << std::endl;
                            	  ...
                            	  break;
                            	  case 3:barras-=6;
                            	  cout<<"Lo atacó pero no llegó muy lejos, el pescador lo secuestro \n ¡No logró llegar!\n ¡Qué mal plan!\n Quedó con "<<barras<< " barras" << std::endl;
                            	  break;
                            	  case 4:
                            	  return 0;
                           	   	  default:
